...
const HIDE_ALERTS_WIDGET = false;

var PopupAlertsManager = {
    displayPopupAlert: function(window,alert) {
    ...
    onContent: function(domObj) {
        ...
        console.log(alerts.length + " relevant alerts.");
        
        for (var alertIdx in alerts) {
            PopupAlertsManager.displayPopupAlert(window,alerts[alertIdx]);
        }
    },
